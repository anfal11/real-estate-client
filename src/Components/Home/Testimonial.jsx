...
const Testimonial = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <h1 className="text-center text-gray-600 font-bold underline text-4xl"> Testimonials </h1>
      ...
      <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto shadow-[0_35px_60px_-15px_rgba(0,0,0,0.5)]">
        <div className="max-w-7xl mx-auto w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
        
          <h2 className="text-2xl sm:text-3xl lg:text-4xl text-gray-400 text-center font-semibold">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {testimonials.map((testimonial, index) => (
                <SwiperSlide key={index} className="flex h-auto">
                  <div className="mb-20 flex flex-col rounded-xl h-72 w-96 md:w-80 xl:w-96 bg-blue-600">
                    <div className="flex-auto p-4 md:p-6">
                      <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">
                        &quot;{testimonial?.message}&quot;
                      </p>
                    </div>
                    <div className="p-4 bg-gray-600 rounded-b-xl md:px-7">
