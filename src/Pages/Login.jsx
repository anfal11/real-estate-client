          ...
          <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            <div className="flex gap-6 justify-center items-center">
              ...
              <p className="font-bold text-4xl font-mono">
                DreamSpace Estate LogIn
              </p>
            </div>
            <div className="mt-12 flex flex-col items-center">
              <div className="w-full flex-1 mt-8">
                <div className="flex flex-col items-center">
                  <button onClick={handleGoogleLogin} className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-blue-500 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
  ...
  <div className="mx-auto max-w-xs">
    ...
    <p className="mt-6 text-xs text-gray-600 text-center">
      ...
      <span className="border-b border-gray-500 border-dotted">
          ...
          <div className="flex-1 bg-blue-500 text-center hidden lg:flex">
            <div
